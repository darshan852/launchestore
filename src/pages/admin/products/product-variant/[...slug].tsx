...
import ProductVariant from "@/src/component/admin/product/productVariant/productVariant"
...
const ProductVariantMain = (props: { productId: string }) => {
  const { productId } = props
  return (
    <AdminLayout>
      <DashboardCard title='Product Variant'>
